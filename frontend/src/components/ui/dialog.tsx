...
function DialogOverlay({ className, ...props }: DialogPrimitive.Backdrop.Props) {
  return (
    <DialogPrimitive.Backdrop
      ...
      className={cn(
        "fixed inset-0 isolate z-50 bg-black/20 backdrop-blur-sm duration-150",
    ...
    <DialogPortal>
      ...
      <DialogPrimitive.Popup
        ...
        className={cn(
          ...
          "gap-5 rounded-2xl bg-popover p-6 text-sm text-popover-foreground shadow-lg",
          "duration-150 outline-none sm:max-w-lg",
