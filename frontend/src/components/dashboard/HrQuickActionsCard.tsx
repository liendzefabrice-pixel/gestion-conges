...
import { Users, ClipboardList, CheckCircle, FileText, Building2, Bell } from 'lucide-react'
...
interface HrQuickActionsCardProps {
  className?: string
}
...
const actions: HrActionItem[] = [
  ...
  },
  {
    ...
    description: 'Gérer les autorisations',
    path: '/permissions',
...
export function HrQuickActionsCard({ className }: HrQuickActionsCardProps) {
  ...
  return (
    <Card className={cn('flex flex-col', className)}>
      <CardHeader>
        ...
        <CardDescription>Accès direct aux fonctionnalités RH</CardDescription>
      </CardHeader>
...
export default HrQuickActionsCard
